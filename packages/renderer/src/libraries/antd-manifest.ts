...
export const ANTD_MANIFEST: AntdComponentMeta[] = [
  ...
  },
  {
    ...
    name: '排版',
    category: 'basic',
    description: '文本排版组件（Text/Title/Paragraph），支持可复制/可编辑/省略等',
    suitable: '✅',
  },
  ...
  },
  {
    ...
    name: '布局',
    category: 'layout',
    description: '页面整体布局（Header/Footer/Sider/Content），常用于后台管理框架',
    suitable: '⚠️',
  },
  {
  ...
  },
  {
    ...
    name: '全局提示',
    category: 'advanced',
    description: '全局提示（编程式 API：message.success/error/info），不适合拖拽',
    suitable: '❌',
  ...
  },
  {
    ...
    name: '包裹组件',
    category: 'basic',
    description: '全局包裹组件，提供 message/notification/modal 的静态方法上下文',
    suitable: '❌',
